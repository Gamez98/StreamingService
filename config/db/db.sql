...
(  1 , 'alan'    , 'gamez'    ,  20 , 'gamez98',   'gamez@hotmail.com'      ,'gamez'   ,'mexico'  ),
(  2 , 'danna'   , 'gomez'    ,  21 , 'gtdanna',   'danna@hotmail.com'      , 'qwertyuiop' , 'usa' ),
(  3 , 'juan'  , 'sanchez'  ,  22 , 'sanchezz',   'sanchez@hotmail.com'       , '123456'   , 'usa'   ),
(  4 , 'mariana' , 'jimenez'  ,  25 , 'marianita', 'majo@hotmail.com'       , 'qwertyuiop' , 'mexico'  ),
(  6 , 'eduardo', 'regalado' ,  35 , 'regalado98' ,'regalado98@hotmail.com' , 'regalado'   , 'spain'  ),
(  7 , 'sergio'  , 'regalado' ,  28 , 'sergio91'   ,'sergio@hotmail.com'     , 'sergio'     , 'mexico');
